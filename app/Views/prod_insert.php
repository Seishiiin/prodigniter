<section>
    <h2 class="text-center mb-5 fw-bold">Ajouter un produit</h2>
    <div class="container">
        <?php echo form_open_multipart('prod/insertProd'); ?>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-6 text-center">
                <?php
                    ...
                    echo anchor("prod/getAll", "<button class='btn btn-primary'>Retour</button>");
